...
<div class="card p-4">
    ...
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" name="patient_name" class="form-control" value="<?= htmlspecialchars($patient['patient_name']) ?>" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="diagnosis" class="form-control" value="<?= htmlspecialchars($patient['diagnosis']) ?>" required>
        </div>
